...
if __name__ == "__main__":
    ...
    # # preisach = initPreisachWithOnes(gridX)
    ...
    model.resetHistory()
    model.setNegSatState()
    # invModel.resetHistory()
    # invModel.setNegSatState()
    ...
    simulation1.save(filename='hysterese_simulation.mp4', fps=24, dpi=300)
    # simulation2.save(filename='hysterese_invertiert_simulation.mp4', fps=24, dpi=300)