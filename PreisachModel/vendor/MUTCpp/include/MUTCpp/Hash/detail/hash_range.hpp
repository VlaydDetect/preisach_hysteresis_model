...
namespace mc
{
    namespace hash_detail
    {
        ...
        hash_range(std::size_t seed, It first, It last)
        {
            ...
            constexpr std::uint32_t q = 0x9e3779b9U;
            constexpr std::uint32_t k = 0xe35e67b1U; // q * q
            ...
            while (n >= 4)
            {
                const std::uint32_t v1 = read32le(p);
...

            {
                ...
                if (n >= 1)
                {
                    ...
                    v1 =
                        static_cast<std::uint32_t>(static_cast<unsigned char>(p[static_cast<std::ptrdiff_t>(x1)])) << x1
                        * 8 |
                        static_cast<std::uint32_t>(static_cast<unsigned char>(p[static_cast<std::ptrdiff_t>(x2)])) << x2
                        * 8 |
                        static_cast<std::uint32_t>(static_cast<unsigned char>(p[0]));
                }
        ...
        hash_range(std::size_t seed, It first, It last)
        {
            ...
            constexpr std::uint64_t q = 0x9e3779b97f4a7c15;
            constexpr std::uint64_t k = 0xdf442d22ce4859b9; // q * q
            ...
            while (n >= 8)
            {
                const std::uint64_t v1 = read64le(p);
...

            {
                ...
                if (n >= 4)
                {
                    v1 = static_cast<std::uint64_t>(read32le(p + static_cast<std::ptrdiff_t>(n - 4))) << (n - 4) * 8 |
                        read32le(p);
                }
                else if (n >= 1)
                {
                    ...
                    v1 =
                        static_cast<std::uint64_t>(static_cast<unsigned char>(p[static_cast<std::ptrdiff_t>(x1)])) << x1
                        * 8 |
                        static_cast<std::uint64_t>(static_cast<unsigned char>(p[static_cast<std::ptrdiff_t>(x2)])) << x2
                        * 8 |
                        static_cast<std::uint64_t>(static_cast<unsigned char>(p[0]));
                }
